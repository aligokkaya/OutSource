...
import { faGear, faCheck, faPen, faP, faStar, faAngleLeft, faAngleRight, faRightToBracket, faRightFromBracket } from '@fortawesome/free-solid-svg-icons'
                ...
                <View style={styles.view}>
                    ...
                    <View style={styles.subView}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10, marginLeft: 30 }}>
                            <View ><Text style={{ fontSize: 14, fontWeight: 'bold', color: '#fff', alignSelf: 'center' }}>Başlangıç</Text>
                                <Text style={{ fontSize: 12, color: '#fff', marginTop: 2 }}>Papel Seviyesi</Text></View>
...
const styles=StyleSheet.create({
    ...
    text:{ marginTop: 10, alignItems: 'center', justifyContent: 'center' },
    childText:{ fontSize: 12, color: '#fff', marginTop: 2 },

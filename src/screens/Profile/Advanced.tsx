...
import { faGear, faCheck, faPen, faStar, faAngleRight, faRightFromBracket, faBuildingColumns, faShield, faUserGroup, faMagnifyingGlass, faTrophy } from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        <SafeAreaView>
            <LinearGradient
                ...
                locations={[0, 0.5, 1]}
                colors={['#56dbe8','#02BDD0','#C7F3F7']} style={{
                    width: '100%',
                    height: '100%',
                }}
            >
                ...
                <View style={styles.view}>
                    <View style={{ marginLeft: 15, alignItems: 'center', justifyContent: 'center' }}>
                        <LinearGradient
                            ...
                            locations={[0, 0.5, 1]}
                            colors={['#02BDD0', '#56dbe8', '#72E1EC']} style={{
                                width: 165,
                                height: 178,
                                borderRadius: 10,
                            }}
                        ...
                        >
                            <View style={styles.shadowView}>
                                <LinearGradient
                                    ...
                                    locations={[0, 0.9, 0]}
                                    colors={['#02BDD0', '#56dbe8', '#C7F3F7']} style={{
                                        width: 80,
                                        height: 80,
                                        borderRadius: 40,
                                    }}
                                >
                                    <View style={{ width: 80, height: 80, borderColor: '#fff', borderRadius: 50, borderWidth: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#000000000' }}>
                                        <FontAwesomeIcon icon={faTrophy} color="#fff" size={33} />
                                        < View style={[styles.bannerIcon, {
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around', marginTop: 10, marginHorizontal: 15, alignSelf: 'flex-end' }}>
                                <View style={{ marginRight: 12 }} >
                                    <Text style={[styles.text, { alignSelf: 'center', marginTop: 0 }]}>İleri</Text>

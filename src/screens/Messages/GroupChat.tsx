...
import { faCheckCircle, faCheckDouble, faChevronLeft, faChevronRight, faChevronUp, faMessage, faPaperPlane, faPlane, faPlus, faSearch } from '@fortawesome/free-solid-svg-icons'
    ...
    return (
        <Background
            ...
            customTitle={
                <TouchableOpacity 
                onPress={() => {
                    navigation.navigate('GroupProfile' as any)
                }}
                style={{
                    flex: 1,
                    flexDirection: 'row',
